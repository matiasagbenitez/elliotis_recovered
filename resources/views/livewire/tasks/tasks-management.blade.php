<div class="container py-6">
    ...
    @if ($running_task)
        <div class="bg-orange-100 border-t-4 border-orange-500 rounded-b text-orange-900 px-4 py-3 shadow-md mb-5 rounded-lg" role="alert">
            <div class="flex">
                ...
                <div>
                    <p class="font-bold">Una tarea de tipo <span class="uppercase">{{ $task_type_name }}</span> se está ejecutando ahora mismo.</p>
                    <p class="text-sm">
                        Si quieres ejecutar otra tarea de este tipo, deberás esperar a que la tarea actual finalice. De lo contrario, la nueva tarea quedará en estado PENDIENTE.
                    </p>
                </div>
            </div>
        </div>
                        ...
                        <tr class="bg-gray-50">
                            ...
                            <td class="px-6 py-3 text-sm">
                                <div class="flex items-center justify-center gap-2">
                                    ...
                                    <x-jet-danger-button wire:click="$emit('deleteTask', '{{ $task['id'] }}')">
