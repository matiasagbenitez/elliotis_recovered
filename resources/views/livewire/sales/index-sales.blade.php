                ...
                <tr class="bg-gray-50">
                    ...
                    <td class="px-6 py-2 whitespace-nowrap text-sm font-medium">
                        <div class="flex items-center justify-end gap-2">
                            @if ($sale->is_active)
                                <button title="Anular venta" wire:click="$emit('disableSale', '{{ $sale->id }}')">
                            ...
                            <a title="Ver detalle cliente" href="{{ route('admin.sales.show-detail-client', $sale) }}">
                                <x-jet-secondary-button>
            ...
            if (reason) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        Livewire.emitTo('sales.index-sales', 'disable', saleId, reason, disableOrder =
                            true);
