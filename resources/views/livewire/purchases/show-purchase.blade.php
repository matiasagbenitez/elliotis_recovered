    ...
    @if (!$purchase->is_active)
        <div
            ...
            <div>
                ...
                El detalle de esta compra no es válida ya que la misma fue cancelada por
                {{ $user_who_cancelled }}
                el día
                {{ Date::parse($purchase->canceled_at)->format('d-m-Y') }}
                a las
                {{ Date::parse($purchase->canceled_at)->format('H:i') }}.
            </div>
        </div>
    @endif
