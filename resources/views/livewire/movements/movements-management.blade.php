    ...
    <x-slot name="header">
        <div class="flex items-center justify-between">
            ...
            <h1 class="font-semibold text-xl text-gray-800 leading-tight">
                <span class="uppercase font-bold">{{ $movement_type_name }}</span>
            </h1>
    ...
    @if ($running_movement)
        <div class="bg-orange-100 border-t-4 border-orange-500 rounded-b text-orange-900 px-4 py-3 shadow-md mb-5 rounded-lg"
            ...
            <div class="flex">
                ...
                <div>
                    <p class="font-bold">Una tarea de tipo <span class="uppercase">{{ $movement_type_name }}</span> se está
        ...
        <div class="bg-stone-100 border-t-4 border-stone-500 rounded-b text-stone-900 px-4 py-3 shadow-md mb-5 rounded-lg"
            ...
            <div class="flex justify-between items-center">
                <div class="flex">
                    ...
                    <div>
                        <p class="font-bold">
                            Ninguna tarea de tipo <span class="uppercase">{{ $movement_type_name }}</span>
    ...
    <x-responsive-table>
        ...
        <div class="px-6 py-4 grid grid-cols-9 gap-3 bg-grat-50">
            ...
            <div class="col-span-2 rounded-lg gap-2">
                ...
                <select class="input-control w-full" wire:model="filters.movement_status_id">
                    <option value="" class="text-md">Todos</option>
                ...
                <tbody class="divide-y divide-gray-200">
                    @foreach ($movements as $movement)
                        <tr class="bg-gray-50">
                            ...
                            <td class="px-6 py-3 text-center">
                                <p class="text-sm uppercase">
                                    {{ $movement['finished_at'] }}
                                </p>
                            </td>
                            <td class="px-6 py-3 text-center">
                                <p class="text-sm uppercase">
                                    {{ $movement['finished_by'] }}
                                </p>
                            </td>
                            <td class="px-6 py-3 text-center">
                            ...
                            <td class="px-6 py-3 text-sm">
                                <div class="flex items-center justify-center gap-2">
                                    @switch($movement['status'])
                                        ...
                                        @case(2)
                                            <x-jet-button wire:click="$emit('finish', '{{ $movement['id'] }}')">
                                                <i class="fas fa-stop"></i>
                                            </x-jet-button>
                                        @break

                                        @case(3)
                                            <x-jet-secondary-button wire:click="showFinishedMovement({{ $movement['id'] }})">
        ...
        Livewire.on('start', () => {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    Livewire.emitTo('movements.movements-management', 'startNewMovement');
        ...
        Livewire.on('finish', movementId => {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    Livewire.emitTo('movements.movements-management', 'finishMovement', movementId);
