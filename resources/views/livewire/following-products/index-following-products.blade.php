<div class="container py-6">
    ...
    <x-responsive-table>
        ...
        <div class="px-6 py-4">
            <h1 class="text-lg pb-2 font-semibold">Seleccione un producto de entrada para ver sus posibles productos de salida</h1>
        ...
        @if ($following_products != null)
            <table class="text-gray-600 min-w-full divide-y divide-gray-200">
                ...
                <tbody class="divide-y divide-gray-200">
                    @foreach ($following_products as $phase)
                        <tr class="bg-gray-50">
                            <td class="px-6 py-3">
