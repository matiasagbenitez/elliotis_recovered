...
class OrdenesDeVenta extends Component
{
    public $audits;
    public $stats = [];
    ...
    {
        $this->audits = Audit::where('auditable_type', 'App\Models\SaleOrder')->orderBy('created_at', 'desc')->get();
        $this->getStats();
    }
    ...
    {
        return view('livewire.audits.ordenes-de-venta');
    }
}
