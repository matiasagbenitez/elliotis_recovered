...
class ProductosAnteriores extends Component
{
    public $audits;
    public $stats = [];
    ...
    {
        $this->audits = Audit::where('auditable_type', 'App\Models\PreviousProduct')->orderBy('created_at', 'desc')->get();
        $this->getStats();
    }
    ...
    {
        return view('livewire.audits.productos-anteriores');
    }
}
