...
class ComprasPDFController extends Controller
{
    public function pdf(Request $request)
    {
        ...
        $pdf = \PDF::loadView('livewire.stadistics.compras-pdf', compact('report_title', 'report_subtitle', 'filters', 'stats', 'company_stats'));
