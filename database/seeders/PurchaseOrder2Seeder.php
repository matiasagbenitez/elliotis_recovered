...
class PurchaseOrder2Seeder extends Seeder
{
    public function run()
    {
        // Orden de compra para proveedor que NO DISCRMINA IVA y de tipo DETALLADA
        ...
        $createForm = [
            ...
            'iva' => 0,
            'total' => 0,
            'observations' => 'Orden de compra para proveedor que NO DISCRMINA IVA y de tipo DETALLADA',
            'type_of_purchase' => 1,
            'total_weight' => 0,
        ];
