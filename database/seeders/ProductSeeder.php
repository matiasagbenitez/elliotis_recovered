    ...
    public function run()
    {
        $products = [
            ...
            [
                ...
                'product_type_id' => 5,
                'phase_id' => 2,
                'unitary_measure' => ProductType::find(5)->measure->m2 * ProductType::find(5)->unity->unities,
                'wood_type_id' => 1,
                'real_stock' => 400,
                'minimum_stock' => 1000,
                'iva_type_id' => 2,
            ...
            [
                ...
                'product_type_id' => 6,
                'phase_id' => 2,
                'unitary_measure' => ProductType::find(6)->measure->m2 * ProductType::find(6)->unity->unities,
                'wood_type_id' => 1,
                'real_stock' => 425,
                'minimum_stock' => 1000,
                'iva_type_id' => 2,
            ...
            [
                ...
                'product_type_id' => 7,
                'phase_id' => 2,
                'unitary_measure' => ProductType::find(7)->measure->m2 * ProductType::find(7)->unity->unities,
                'wood_type_id' => 1,
                'real_stock' => 400,
                'minimum_stock' => 1000,
                'iva_type_id' => 2,
            ...
            [
                ...
                'product_type_id' => 8,
                'phase_id' => 2,
                'unitary_measure' => ProductType::find(8)->measure->m2 * ProductType::find(8)->unity->unities,
                'wood_type_id' => 1,
                'real_stock' => 475,
                'minimum_stock' => 1000,
                'iva_type_id' => 2,
            ...
            [
                ...
                'product_type_id' => 9,
                'phase_id' => 3,
                'unitary_measure' => ProductType::find(9)->measure->m2 * ProductType::find(9)->unity->unities,
                'wood_type_id' => 1,
                'real_stock' => 500,
                'minimum_stock' => 1000,
                'iva_type_id' => 2,
            ...
            [
                ...
                'product_type_id' => 10,
                'phase_id' => 3,
                'unitary_measure' => ProductType::find(10)->measure->m2 * ProductType::find(10)->unity->unities,
                'wood_type_id' => 1,
                'real_stock' => 525,
                'minimum_stock' => 1000,
                'iva_type_id' => 2,
            ...
            [
                ...
                'product_type_id' => 11,
                'phase_id' => 3,
                'unitary_measure' => ProductType::find(11)->measure->m2 * ProductType::find(11)->unity->unities,
                'wood_type_id' => 1,
                'real_stock' => 500,
                'minimum_stock' => 1000,
                'iva_type_id' => 2,
            ...
            [
                ...
                'product_type_id' => 12,
                'phase_id' => 3,
                'unitary_measure' => ProductType::find(12)->measure->m2 * ProductType::find(12)->unity->unities,
                'wood_type_id' => 1,
                'real_stock' => 525,
                'minimum_stock' => 1000,
                'iva_type_id' => 2,
            ...
            [
                ...
                'product_type_id' => 13,
                'phase_id' => 4,
                'unitary_measure' => ProductType::find(13)->measure->m2 * ProductType::find(13)->unity->unities,
                'wood_type_id' => 1,
                'real_stock' => 600,
                'minimum_stock' => 300,
                'iva_type_id' => 2,
            ...
            [
                ...
                'product_type_id' => 14,
                'phase_id' => 4,
                'unitary_measure' => ProductType::find(14)->measure->m2 * ProductType::find(14)->unity->unities,
                'wood_type_id' => 1,
                'real_stock' => 625,
                'minimum_stock' => 300,
                'iva_type_id' => 2,
            ...
            [
                ...
                'product_type_id' => 15,
                'phase_id' => 4,
                'unitary_measure' => ProductType::find(15)->measure->m2 * ProductType::find(15)->unity->unities,
                'wood_type_id' => 1,
                'real_stock' => 600,
                'minimum_stock' => 300,
                'iva_type_id' => 2,
            ...
            [
                ...
                'product_type_id' => 16,
                'phase_id' => 4,
                'unitary_measure' => ProductType::find(16)->measure->m2 * ProductType::find(16)->unity->unities,
                'wood_type_id' => 1,
                'real_stock' => 625,
                'minimum_stock' => 300,
                'iva_type_id' => 2,
            ...
            [
                ...
                'product_type_id' => 17,
                'phase_id' => 5,
                'unitary_measure' => ProductType::find(17)->measure->m2 * ProductType::find(17)->unity->unities,
                'wood_type_id' => 1,
                'is_salable' => true,
                'real_stock' => 1,
                'minimum_stock' => 4,
            ...
            [
                ...
                'product_type_id' => 18,
                'phase_id' => 5,
                'unitary_measure' => ProductType::find(18)->measure->m2 * ProductType::find(18)->unity->unities,
                'wood_type_id' => 1,
                'is_salable' => true,
                'real_stock' => 1,
                'minimum_stock' => 4,
            ...
            [
                ...
                'product_type_id' => 19,
                'phase_id' => 5,
                'unitary_measure' => ProductType::find(19)->measure->m2 * ProductType::find(19)->unity->unities,
                'wood_type_id' => 1,
                'is_salable' => true,
                'real_stock' => 1,
                'minimum_stock' => 4,
            ...
            [
                ...
                'product_type_id' => 20,
                'phase_id' => 5,
                'unitary_measure' => ProductType::find(20)->measure->m2 * ProductType::find(20)->unity->unities,
                'wood_type_id' => 1,
                'is_salable' => true,
                'real_stock' => 1,
                'minimum_stock' => 4,
